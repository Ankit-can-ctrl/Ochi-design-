...
function Navigation() {
  ...
  return (
    <div className="bg-black text-white font-Founder rounded-b-xl px-10 py-8">
      <div className=" w-full flex items-center justify-between">
        ...
        <div className="big-links hidden  lg:flex w-[70%] gap-20 items-center">
          {pagesLink.map((item, index) => (
            <motion.a
              whileHover={{ scale: 1.2 }}
              transition={{ duration: 1 }}
              className={`capitalize text-2xl leading-none  ${
                index === pagesLink.length - 1 ? " pl-[40%]" : ""
              }`}
              key={index}
              href="#"
            >
