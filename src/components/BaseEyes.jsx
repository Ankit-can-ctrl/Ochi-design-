...
function BaseEyes() {
  ...
  return (
    <div>
      <div className="each-eye flex w-full gap-10 py-20 items-center justify-center">
        <div className=" relative each-eye-main flex items-center justify-center h-[30vw] w-[30vw] md:w-[15vw] md:h-[15vw] rounded-full bg-zinc-100">
