  ...
  return (
    <div className="w-full  bg-black">
      <div className="header border-b-2 border-zinc-400 p-20 flex items-center justify-between">
        ...
        <div className="close text-2xl cursor-pointer">
          <svg
            stroke="currentColor"
            fill="currentColor"
      ...
      <div className="menu-links">
        <div className="main-links">
          <div className="links flex flex-col p-10 gap-2 ">
            {navlinks.map((item, index) => (
              <a
                key={index}
                className="text-6xl tracking-tighter font-bold font-Founder leading-none capitalize cursor-pointer"
              >
                {item}
              </a>
            ))}
        ...
        <div className="flex flex-col gap-4 p-10 font-Neue text-xl">
          <h1>L:</h1>
