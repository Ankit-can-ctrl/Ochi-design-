  ...
  return (
    <div className="bg-white w-full rounded-t-2xl px-10 py-10">
        ...
        <div>
          ...
          <div className="links flex flex-col py-20 gap-10">
            <div className="social-links">
              <h1 className=" font-Neue text-xl">S:</h1>
              <div className="flex flex-col text-xl py-5 gap-3 capitalize underline font-Neue">
      ...
      <div className=" font-Neue text-xl footer-end text-black flex flex-col xl:flex-row w-full items-start xl:items-center justify-between pt-20 gap-10">
        ...
        <div className=" text-zinc-400">&copy;ochi design 2024 Legal Terms</div>
        <div className=" text-zinc-400">Website by Ankit :)</div>
      </div>
    </div>
  );
}
